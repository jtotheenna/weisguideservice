  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div style={{ padding: "28px", borderRadius: "18px", background: "#f6f7f8", textAlign: "left" }}>
            <h3>Drift Boat — Full Day</h3>
            <p style={{ fontSize: "1.25rem", fontWeight: 600 }}>$600</p>
            <p>1–2 anglers</p>
            <p>Guided float trips on local rivers, including the South Branch of the Root River.</p>
          </div>
          ...
          <div style={{ padding: "28px", borderRadius: "18px", background: "#f6f7f8", textAlign: "left" }}>
            ...
            <p>1–2 anglers</p>
            <p>Shorter float option ideal for limited schedules or evening trips.</p>
          </div>
          ...
          <div style={{ padding: "28px", borderRadius: "18px", background: "#f6f7f8", textAlign: "left" }}>
            ...
            <p>1–2 anglers</p>
            <p>Full-day walk-and-wade trips on spring creeks and smaller rivers.</p>
          </div>
          ...
          <div style={{ padding: "28px", borderRadius: "18px", background: "#f6f7f8", textAlign: "left" }}>
            ...
            <p>1–2 anglers</p>
            <p>Half-day option focused on technique, reading water, and seasonal hatches.</p>
          </div>
        </div>
        ...
        >
          ...
          <p>
            A deposit is required at the time of booking. Cancellations within 24 hours of the trip date
            or no-shows will result in a charge of 100% of the trip’s total cost.
          </p>

          <p>
            Cancellations made within 5 days of the trip date will forfeit the deposit. Deposits may be
            credited toward a future trip at the guide’s discretion.
          </p>
